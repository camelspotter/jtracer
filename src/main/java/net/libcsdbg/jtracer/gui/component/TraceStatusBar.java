...
public class TraceStatusBar extends JPanel implements AutoInjectable
{
	...
	{
		setField("message", Config.undefinedValue);
		setField("timestamp", Config.undefinedValue);
		setField("address", Config.undefinedValue);
	...
	public TraceStatusBar setField(String name, String text)
	{
		...
		try {
			SwingUtilities.invokeLater(() -> setField(name, text));
		}
		catch (Throwable err) {
