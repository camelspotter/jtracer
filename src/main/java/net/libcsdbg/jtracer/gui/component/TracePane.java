...
public class TracePane extends JTextPane implements AutoInjectable
{
	...
	public TracePane(Map<String, String> request)
	{
		...
		append(request.get("trace")
		              .replace("  ", "\t"));
	}

	protected TracePane append(String trace)
	{
		...
		if (tokenizer.hasRemainder()) {
			return append(tokenizer.remainder());
		}

		return this;
	}

	protected TracePane append(Token token)
	{
	...
	protected TracePane append(String text, String tag)
	{
		try {
